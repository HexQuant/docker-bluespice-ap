...
if [ -f "/opt/docker/.firstrun" ]; then
    ...
    if ! [[ -d "/data/mysql" ]] && ! [[ -f "/data/www/bluespice/w/LocalSettings.php" ]]; then
        ...
        mv /data/www/bluespice /data/www/w > /dev/null 2>&1
        mv /data/www/luespice /data/www/w > /dev/null 2>&1
        mkdir -p /data/www/bluespice > /dev/null 2>&1
        mv /data/www/w /data/www/bluespice > /dev/null 2>&1
        ...
        /usr/bin/mysql_install_db  --force --datadir=/data/mysql > /dev/null 2>&1
